...
import threading
import sys
sys.path.append(r"C:\Users\EMI_user1\Desktop\radar\testing_projects")
from fft3d_window import FFT3DWindow
# This is a test code
    ...
    def MeasUpdate(self):
        ...
        if NrFrms < 0:
            ...
            if ProcData:
                ...
                print("================================")
                print("RADAR MATRIX INFORMATION")
                print("================================")
                print("Rows     :", self.MeasData.shape[0])
                print("Columns  :", self.MeasData.shape[1])
                print("Elements :", self.MeasData.size)
                print("Bytes    :", self.MeasData.nbytes)
                print("================================")
                ...
                "w"
                    ...
                    f.write("RADAR MATRIX INFORMATION\n")
                    f.write("========================\n")
